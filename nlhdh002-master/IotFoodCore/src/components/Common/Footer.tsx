              ...
              <Stack direction="column" spacing={1}>
                ...
                <Typography sx={{ "&:hover": { textDecoration: "underline" } }}>
                  <Link
                    ...
                    target="_blank"
                  >
                    Cong Nghiep University (facebook)
                  </Link>
                </Typography>
                <Typography sx={{ "&:hover": { textDecoration: "underline" } }}>
                  <Link
                    ...
                    target="_blank"
                  >
                    Cong Nghiep Information Technology Club (TLIT)
                  </Link>
                </Typography>
        ...
        <Grid sx={{ mb: "20px" }} container spacing={2}>
          ...
          <Grid item xs={4}>
            <p className="text-white">
              Đây là dự án trong chuỗi phát triển của sinh viên Haui
              chúc bạn có 1 trải nghiệm tốt. Xin cảm ơn!
            </p>
            <Divider
