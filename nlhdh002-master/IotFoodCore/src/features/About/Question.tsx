...
const dataQuestion = [
  {
    question: "HauiFood hoạt động như nào?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Bạn không thể vì chúng tôi chỉ ship tới cố định địa điểm là Trường đại học Công Nghiêp",
  },
  {
    question:
      "Tôi có thể thanh toán trực tuyến trên HauiFood cho đơn hàng của mình không?",
    answer:
      "Chúng tôi chưa hỗ trợ dịch vụ thanh toán trực tuyến trên bản cập nhật lần này",
  },
  {
    question: "Tôi có thể đặt đồ ăn trên HauiFood cho người khác không?",
    answer:
  ...
  {
    question: "HauiFood tính phí giao đồ ăn như thế nào?",
    answer:
